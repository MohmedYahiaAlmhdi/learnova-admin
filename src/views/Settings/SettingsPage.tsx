  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="general" className="space-y-4">
        <TabsList className="bg-card border border-border p-1 h-10 flex flex-wrap">
          <TabsTrigger
            value="general"
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-end">
                  <div className="flex items-center justify-between p-4 rounded-xl bg-background border border-border w-full">
                    <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select value={currency} onValueChange={setCurrency}>
                    <SelectTrigger className="w-full h-11 bg-background border-border text-sm text-foreground/80 rounded-xl">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="bg-card border-border">
                      <SelectItem value="USD" className="text-foreground/80">USD - US Dollar</SelectItem>
                      <SelectItem value="EUR" className="text-foreground/80">EUR - Euro</SelectItem>
                      <SelectItem value="GBP" className="text-foreground/80">GBP - British Pound</SelectItem>
                      <SelectItem value="AED" className="text-foreground/80">AED - UAE Dirham</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent className="bg-card border-border">
                      <SelectItem value="weekly" className="text-foreground/80 capitalize">Weekly</SelectItem>
                      <SelectItem value="biweekly" className="text-foreground/80 capitalize">Bi-weekly</SelectItem>
                      <SelectItem value="monthly" className="text-foreground/80 capitalize">Monthly</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
                  ...
                  {paymentMethodOptions.map((method) => (
                    ...
                    >
                      <Checkbox
                        ...
                        className="data-[state=checked]:bg-[#4F46E5] data-[state=checked]:border-[#4F46E5] border-border bg-card"
                      />
